                    ...
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <form action="{{route('register')}}" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form2Example11"><i class="fas fa-user"></i>Nombre</label>
                        ...
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form2Example22"><i class="fas fa-lock"></i>Confirmar Contraseña</label>
